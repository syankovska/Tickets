...
<asp:Content  ID="Content1" ContentPlaceHolderID="MainContent"
    runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" Caption="Select Sessions" CellPadding="4" DataSourceID="ObjectDataSource1" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" AutoGenerateColumns="False" AutoGenerateSelectButton="True" DataKeyNames="SessionId,CinemaId">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="SessionBusinessDate" HeaderText="SessionBusinessDate" SortExpression="SessionBusinessDate" />
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetSessionsByScheduledFilmAndSessionBusinessDate" TypeName="Tickets.SyTicketsSvc.SessionsClient" ConvertNullToDBNull="True" OnSelecting="ObjectDataSource1_Selecting">
            <SelectParameters>
